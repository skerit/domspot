...
h.a,d.e),d.b&&3===g.nodeType&&g.nodeValue!==h.b&&b.push(t({type:"characterData",target:g,oldValue:h.b})),d.d&&p(g,h)}p(a,c)},I=function(b,a){var c=A(b,a);return function(d){var e=d.length;a.a&&c.a&&y(d,b,c.a,a.e);(a.c||a.d)&&H(d,b,c,a);d.length!==e&&(c=A(b,a))}},e=function(b){var a=this;a.g=[];a.k=function(){var c=a.takeRecords();c.length&&b.call(a,c,a);a.f=setTimeout(a.k,e._period)}};e._period=900;e.prototype.observe=function(b,a){for(var c=this.g,d=0;d<c.length;d++)if(c[d].m===b){c.splice(d,1);break}d=
